    ...
    <>
      <div className="p-2 bg-black">
        <Navbar className="navbar rounded-xl p-2 bg-gray-900 ">
          ...
          <NavbarContent className=" lg:flex  hidden gap-8" justify="center">
            <NavbarItem isActive>
              <Button
                color="primary"
                className="font-bold text-white p-6"
                onClick={()=> router.push("/Admin/AddPIMain")}
              >
                ADD PI
              </Button>
            </NavbarItem>
            <NavbarItem isActive>
              <Button
                color="primary"
                className="font-bold text-white p-6"
                onClick={()=> router.push("/Admin/AddPOMain")}
              >
                ADD PO <br />
                (Supplier)
              </Button>
            ...
            <NavbarItem>
              <Button
                color="primary"
                className="font-bold text-white p-6"
                onClick={()=> router.push("/Admin/AddSoMain")}
              >
                ADD SO <br /> (Customer)
              </Button>
            </NavbarItem>
            ...
            <NavbarItem>
              <Button
                color="primary"
                className="font-bold text-white p-6"
                onClick={()=> router.push("/Admin/PlanningOrder/suggestedPlanningOrder")}
              >
                ADD Planning Order
              </Button>
            </NavbarItem>
            ...
            <Dropdown placement="bottom-end">
              ...
              <DropdownMenu aria-label="Profile Actions" variant="flat">
               ...
               <span className="font-bold">  Name: {Name} </span>
                ...
                <DropdownItem key="RoleName" color="primary" className="font-bold">
        ...
        <Drawer open={open} onClose={closeDrawer} className="bg-black">
          ...
          <List>
            ...
            <ListItem
              className="text-white lg:hidden md:hidden flex"
              onClick={()=> router.push("/Admin/AddPOMain")}
            >
              <ListItemPrefix>
                <svg
            ...
            <ListItem
              className="text-white "
              onClick={() => {
                router.push("/Admin/QualityCheck");
              }}
            >
              <ListItemPrefix>
                <svg
            ...
            <ListItem
              className="text-white "
              onClick={() => {
                router.push("/Admin/QualityCheckGrn");
              }}
            >
              <ListItemPrefix>
                <svg
            ...
            <ListItem
              className="text-white "
              onClick={() => {
                router.push("/Admin/UserManagment");
              }}
            >
              <ListItemPrefix>
                <svg
